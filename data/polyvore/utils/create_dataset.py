...
save_path = r'C:\\Users\\Software\\Downloads\\polyvore-images\\dataset\\'
if not os.path.exists(save_path):
    os.makedirs(save_path)

dataset_path =  "C:\\Users\\Software\\Downloads\\polyvore-images\\jsons\\"
...
if os.path.exists(feat_pkl):
    ...
    raise print('The extracted features file {} does not exist'.format(feat_pkl))
...
for rel in relations:
    try:
        ...
        for related in rel_list:
            ...
            sp_adj[to_idx, from_idx] = 1
    except:
        pass # because it is symmetric
print("hey 3")
print('Done!')
